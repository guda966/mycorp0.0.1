...
export const servicesData: ServiceData[] = [
  ...
  },
  {
    ...
    benefits: [
      { title: "Healthcare Software & Apps", desc: "Patient portals, EHR integrations, clinical dashboards, and custom health-tech platforms built to HIPAA standards." },
      { title: "Medical Billing & Coding", desc: "AAPC-certified ICD-10 and CPT coders with specialty-specific expertise to maximize first-pass claim acceptance." },
      { title: "Revenue Cycle Management", desc: "End-to-end RCM — pre-submission scrubbing, denial management, AR follow-up, and payer contract analysis." },
    ...
    specialties: [
      "Medical Billing & Coding", "ICD-10 / CPT / HCPCS", "Denial Management & Appeals", "Accounts Receivable Recovery",
      "EHR Integration & Implementation", "Patient Portal Development", "Healthcare Data Analytics", "Provider Credentialing",
    ],
    process: [
      { step: "01", title: "Healthcare Assessment", desc: "We review your current systems, workflows, and revenue leakage points to scope the right solution." },
      { step: "02", title: "Solution Design", desc: "Whether it's a software build or RCM setup, we design a plan aligned to your clinical and financial goals." },
      { step: "03", title: "Delivery & Integration", desc: "Agile project delivery or ongoing billing operations — we execute with full transparency and daily reporting." },
      { step: "04", title: "Reporting & Optimisation", desc: "Detailed financial and technical reports with strategic reviews to continuously improve outcomes." },
    ],
    stats: [
