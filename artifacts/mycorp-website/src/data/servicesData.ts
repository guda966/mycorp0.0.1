...
export const servicesData: ServiceData[] = [
  ...
  },
  {
    ...
    longDescription: "Healthcare providers lose millions annually to claim denials, coding errors, and slow AR cycles. MyCorp's RCM team manages your entire revenue cycle so your clinical staff can focus on patients, not paperwork.",
    benefits: [
